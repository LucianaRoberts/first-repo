...
with open(file,newline="", encoding="utf-8") as elections:
    ...
    for row in csvreader: 
        ...
        #If the name is found, count the times it appears and store in a list
        if row[2] == "Khan": 
            khan_votes +=1
        elif row[2] == "Correy":
            correy_votes +=1
...
# Output files
output_file = Path("Election_analysis.txt")

with open("Election_analysis.txt" ,"w") as file:

# Output file "Elections_Analysis" 
